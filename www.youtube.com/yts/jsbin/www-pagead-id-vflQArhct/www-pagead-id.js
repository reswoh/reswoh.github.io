...
function v(a,b){var c=a.split("."),d=r;c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)c.length||void 0===b?d[e]&&d[e]!==Object.prototype[e]?d=d[e]:d=d[e]={}:d[e]=b}
...
function bb(a,b){var c=b.format||"JSON";a=cb(a,b);var d=db(a,b),e=!1,f,g=eb(a,function(a){if(!e){e=!0;f&&window.clearTimeout(f);var d=Wa(a),g=null;if(d||400<=a.status&&500>a.status)g=fb(c,a,b.F);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};var h=b.context||r;d?b.l&&b.l.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.A&&b.A.call(h,a,g)}},b.method,d,b.headers,b.responseType,b.withCredentials);
b.m&&0<b.timeout&&(f=Xa(function(){e||(e=!0,g.abort(),window.clearTimeout(f),b.m.call(b.context||r,g))},b.timeout));
return g}
...
;function jb(){var a=kb()?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=qa(),c;return O(new L(function(d,e){b.l=function(a){Wa(a)?d(a):e(new U("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){e(new U("Unknown request error","net.unknown",a))};
b.m=function(a){e(new U("Request timed out","net.timeout",a))};
c=bb(a,b)}),function(a){a instanceof P&&c.abort();
return N(a)})}
...
q(X,B);X.prototype.name="BiscottiMissingError";var ra={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Y=null;function nb(){if("1"===pa(T("PLAYER_CONFIG",{}),"args","privembed"))return N(Error("Biscotti ID is not available in private embed mode"));Y||(Y=O(jb().then(ob),function(a){return pb(2,a)}));
return Y}
function kb(){var a;(a=!!pa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie"))||(a=!!T("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1));a||(a=!!T("EXPERIMENT_FLAGS",{}).html5_serverside_pagead_id_sets_cookie);return a}
